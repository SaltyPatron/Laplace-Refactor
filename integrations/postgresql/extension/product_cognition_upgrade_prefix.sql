...
-- before exposing any readback surface. Fresh 1.0.4 installations never execute
...
BEGIN
    ...
    END IF;
    IF version IN ('1.0.1', '1.0.2', '1.0.3') THEN
        ALTER EXTENSION laplace UPDATE TO '1.0.4';
    ELSIF version <> '1.0.4' THEN

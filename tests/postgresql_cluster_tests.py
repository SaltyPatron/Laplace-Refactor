...
class PostgreSQLClusterContract(unittest.TestCase):
    ...
    def test_existing_default_huge_pages_preserves_plan_without_writing_configuration(self) -> None:
        plan = self.plan()
        ...
        # The current contract already disables huge pages. Identical installed
        # bytes cannot establish that an extra physical selection was made.
        self.assertEqual(plan["settings"]["huge_pages"], "off")

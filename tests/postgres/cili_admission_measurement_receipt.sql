-- Emit the repaired real-CILI cardinality/replay proof as one machine-readable line.
-- custom_stack_qa.py copies LAPLACE_QA_RECEIPT lines into the durable terminal QA
-- result before the disposable PostgreSQL workspace is removed.

...
add_executable(laplace_cognition_operator_tests
    ...
    "${PROJECT_SOURCE_DIR}/tests/target_safetensors_tests.cpp"
    "${PROJECT_SOURCE_DIR}/tests/target_attention_safetensors_tests.cpp")
...
gtest_discover_tests(laplace_cognition_operator_tests PROPERTIES
    LABELS "implementation;cognition;operator;target-compile;target-scope-plan;target-factorization;target-attention;target-package;target-safetensors;target-attention-safetensors;incidence;relation-plane;evidence;matrix-free;receipt")

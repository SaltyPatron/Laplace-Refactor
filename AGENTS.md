...
- A prompt enters as one exact canonical observation/trunk. Cognition may descend/rise
  through its constituents, but may not privilege a topic, noun, token, punctuation
  class, or English regex dispatcher as the interpretation root.
...
- Structural geometry/locality and semantic/evidence state are orthogonal typed planes.
  ...
  related calculations may propose/measure declared structural state; they do not

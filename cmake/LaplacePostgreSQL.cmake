...
function(laplace_discover_postgresql pg_config_path)
    ...
    foreach(query version includedir-server includedir bindir libdir pkglibdir sharedir)
    ...
    laplace_map_postgresql_path("${pg_libdir}" pg_libdir_physical)
    ...
    if(NOT EXISTS "${pg_includedir_physical}/libpq-fe.h")
        message(FATAL_ERROR
            "PostgreSQL client headers are absent from ${pg_includedir_physical}")
    endif()
    ...
    set(LAPLACE_POSTGRES_LIBDIR "${pg_libdir_physical}" PARENT_SCOPE)
    ...
    set(LAPLACE_POSTGRES_LOGICAL_LIBDIR "${pg_libdir}" PARENT_SCOPE)

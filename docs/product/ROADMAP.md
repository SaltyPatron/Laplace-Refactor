...
| `world.discover-qualify-sources` | Deterministic discovery catalog and qualified Tree-sitter/codec/standards-provider receipts without source-authority promotion | #112 | Partial: recursive catalog and source-estate profile resolution contracts are committed; provider qualification and accepted product receipts remain absent | Relocation-invariant catalog plus bounded provider coverage/error/recovery/reconstruction receipts |

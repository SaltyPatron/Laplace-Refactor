...
python3 "$repo_root/tests/product_release_capacity_footprint_tests.py"
python3 "$repo_root/tests/product_release_reuse_install_tests.py"
...
python3 "$repo_root/tests/highway_committed_revalidation_tests.py"
python3 "$repo_root/tests/product_activation_runtime_adapter_tests.py"
python3 "$repo_root/tests/product_activation_runner_tests.py"
python3 "$repo_root/tests/product_service_state_tests.py"
python3 "$repo_root/tests/receipt_estate_tests.py"

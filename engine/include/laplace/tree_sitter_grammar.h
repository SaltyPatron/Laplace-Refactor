 ...
 * are execution inputs; provider_fingerprint is semantic/execution authority
 * and must bind the exact grammar repository revision, generated parser/scanner
 * bytes, build recipe, shared object, and Tree-sitter runtime generation.
 */

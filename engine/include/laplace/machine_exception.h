...
#define LAPLACE_MACHINE_EXCEPTION_BIND_PROGRAM (UINT64_C(1) << 0)
#define LAPLACE_MACHINE_EXCEPTION_BIND_PHYSICAL_PLAN (UINT64_C(1) << 1)
#define LAPLACE_MACHINE_EXCEPTION_BIND_PROVIDER (UINT64_C(1) << 2)
#define LAPLACE_MACHINE_EXCEPTION_BIND_NODE (UINT64_C(1) << 3)
#define LAPLACE_MACHINE_EXCEPTION_BIND_WORLD_SCOPE (UINT64_C(1) << 4)
#define LAPLACE_MACHINE_EXCEPTION_BIND_TRANSACTION (UINT64_C(1) << 5)
#define LAPLACE_MACHINE_EXCEPTION_BIND_LAST_VALID_RECEIPT (UINT64_C(1) << 6)
#define LAPLACE_MACHINE_EXCEPTION_BIND_DURABLE_BOUNDARY (UINT64_C(1) << 7)
#define LAPLACE_MACHINE_EXCEPTION_BIND_REPLAY_ORIGIN (UINT64_C(1) << 8)
#define LAPLACE_MACHINE_EXCEPTION_BIND_INVALIDATED_OUTPUT (UINT64_C(1) << 9)
